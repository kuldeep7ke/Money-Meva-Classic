...
import { Settings as SettingsIcon, Moon, Sun, Globe, Clock, Shield, Save, Monitor, Users, AlertTriangle, Crown, Home } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-base mt-1" style={{ color: 'var(--text-secondary)' }}>Configure your app preferences</p>
            </div>
          </div>
        </div>
